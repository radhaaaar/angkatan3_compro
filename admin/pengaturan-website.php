...
if (isset($_POST['simpan'])) {
    ...
    //mencari data didalam tabel pengaturan, jika ada data akan diupdate
    //jika tidak ada akan ada di insert
    ...
    if (mysqli_num_rows($queryPengaturan) > 0) {
        if (!empty($_FILES['foto']['name'])) {
            ...
            if (!in_array($extFoto, $ext)) {
                ...
                $update = mysqli_query(
                    $koneksi,
                    "UPDATE general_setting SET website_name='$website_name', website_link='$website_link',logo='$nama_foto',
                    website_phone='$website_phone',website_email='$website_email',website_address='$website_address' WHERE id='$id'"
                );
            }
        } else {
...
//     header("location:pengaturan-website.php?ubah=berhasil");
// }
                                        ...
                                        <form action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="mb-3 row">
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="website_name" placeholder="masukan telp website" required
                                                            value="<?php echo isset($rowPengaturan['website_name']) ? $rowPengaturan['website_name'] : "" ?>">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="" class="form-label">Telepon</label>
                                                        <input type="text" class="form-control" name="website_phone" placeholder="masukan nama website" required
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="url" class="form-control" name="website_link" placeholder="masukan link website anda"
                                                            value="<?php echo isset($rowPengaturan['website_link']) ? $rowPengaturan['website_link'] : "" ?>" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="" class="form-label">Email Website</label>
                                                        <input type="text" class="form-control" name="website_email" placeholder="masukan email website" required
                                            ...
                                            <div class="mb-3 row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <input type="text" name="website_address" placeholder="masukan alamat website anda" class="form-control" id=""
