...
if (isset($_POST['edit'])) {
    ...
    if (!empty($_FILES['foto']['name'])) {
        ...
        // user tidak ingin memasukkan gambar
        $update = mysqli_query($koneksi, "UPDATE instruktur SET nama_instruktur='$nama_instruktur', jurusan_instruktur='$jurusan_instruktur', foto='$nama_foto' WHERE id='$id'");
    }
                                        ...
                                        <form action="" method="post" enctype="multipart/form-data">
                                            <div class="mb-3 row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" class="form-control" name="nama_instruktur" placeholder="masukan nama Instruktur" required
                                                        value="<?php echo isset($_GET['edit']) ? $rowEdit['nama_instruktur'] : "" ?>">
                                                </div>
                                                <div class="col-sm-6">
                                                    <label for="" class="form-label">Jurusan</label>
                                                    <input type="text" class="form-control" name="jurusan_instruktur" placeholder="masukan jurusan instruktur"
                                                        value="<?php echo isset($_GET['edit']) ? $rowEdit['jurusan_instruktur'] : "" ?>" required>
                                                </div>
                                            </div>
                                            <!-- <div class="mb-3 row">
                                                <div class="col-sm-12">
